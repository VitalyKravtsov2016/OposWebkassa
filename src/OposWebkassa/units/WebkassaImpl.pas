...
begin
  ...
  Document.AddLine(Document.AlignCenter(Tnt_WideFormat('����� �%d', [Data.ShiftNumber])));
  ...
  Document.AddLine('�����: ' + Data.DateTime);
  Document.AddLine('���: ' + Data.Cashbox.Ofd.Name);
  Document.AddLine('��� �������� ����:');
  ...
  Document.AddLine('��� ���: ' + Data.Cashbox.IdentityNumber);
  Document.AddLine('��� ��� ��� (���): ' + Data.Cashbox.RegistrationNumber);
  Document.AddLine('���: ' + Data.Cashbox.UniqueNumber);
  Document.AddSeparator;
  Document.AddText(Receipt.Trailer.Text);
end;
