...
begin
  ...
  Document.Add(AlignCenter(Format('—ÏÂÌ‡ %d', [Command.Data.ShiftNumber]), Document.LineChars));
  ...
  if Amount <> 0 then
  begin
    Document.AddLines(Format('‚ Ú.˜. Õƒ— %d %%', [VATPercent]),
      CurrencyToStr(Amount));
  end;
  Document.AddSeparator;
  Document.AddLines('‘ËÒÍ‡Î¸Ì˚È ÔËÁÌ‡Í:',  );
  Command.Data.
*)
