...
type
  ...
  public
    ...
    function TestPrinterConnection: WideString;
...
function TWebkassaImpl.TestPrinterConnection: WideString;
const
...
function TWebkassaImpl.GetPropVal(const PropertyName: WideString): WideString;
var
  Value: Variant;
  Intf: IDispatch;
  PName: PWideChar;
...
procedure TWebkassaImpl.AddProp(const PropName: WideString; PropText: WideString);
var
  Line: WideString;
begin
...
procedure TWebkassaImpl.AddProps;
begin
...
const
  CashOutReceiptText: string =
    '                                          ' + CRLF +
    '   ¬ÓÒÚÓ˜ÌÓ- ‡Á‡ÒÚ‡ÌÒÍ‡ˇ Ó·Î‡ÒÚ¸, „ÓÓ‰   ' + CRLF +
    '    ”ÒÚ¸- ‡ÏÂÌÓ„ÓÒÍ, ÛÎ. √ÂÈ‰ÂÌ‡ˇ, 1/10' + CRLF +
    '            “ŒŒ PetroRetail               ' + CRLF +
    '¡»Õ                                       ' + CRLF +
    '«ÕÃ  »Õ  Œ‘ƒ                              ' + CRLF +
    '»«⁄ﬂ“»≈ ƒ≈Õ≈√ »«  ¿——€              =60.00' + CRLF +
    'Õ¿À»◊Õ€’ ¬  ¿——≈                     =0.00' + CRLF +
    '           CallˆÂÌÚ 039458039850         ' + CRLF +
    '          √Óˇ˜‡ˇ ÎËÌËˇ 20948802934       ' + CRLF +
    '            —œ¿—»¡Œ «¿ œŒ ”œ ”            ' + CRLF +
    '                                          ';

function TWebkassaImpl.PrintTestReceipt: WideString;
var
  i: Integer;
  Lines: TStrings;
begin
...
function TWebkassaImpl.ReadDeviceList: WideString;
begin

end;

function TWebkassaImpl.GetFontNames: WideString;
begin
