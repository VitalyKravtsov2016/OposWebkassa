...
begin
  ...
  try
    ...
    try
      ...
      Document.AddLines('—”ÃÃ¿ ¬Õ≈—≈Õ»…', AmountToStr(Command.Data.PutMoneySum));
      Document.AddLines('—”ÃÃ¿ »«⁄ﬂ“»…', AmountToStr(Command.Data.TakeMoneySum));
...
procedure TWebkassaImpl.SetReceiptRequestParams(
  ...
  (*
  ÁÌ‡˜ÂÌËÂ "4" DirectIO(30, 73, '4') ˝ÚÓ ÛÒÎÛ„‡
  ÁÌ‡˜ÂÌËÂ 1, 2, 30, 31, 32, 33 ˝ÚÓ ÚÓ‚‡
  Ë DirectIO(30, 73, '3') ˝ÚÓ "‡·ÓÚ‡"(Ì‡ ÚÂÍÛ˘ËÈ ÏÓÏÂÌÚ ÌÂ ËÒÔÓÎ¸ÁÛÂÚÒˇ Ë ÌÂ ÔÎ‡ÌËÛÂÚÒˇ)
  *)
...
begin
  ...
  Document.AddLine(Document.AlignCenter(Tnt_WideFormat('—Ã≈Õ¿ π%d', [Data.ShiftNumber])));
  Document.AddLine(OperationTypeToText(Request.OperationType));

  //Document.AddLine(AlignCenter(WideFormat('œÓˇ‰ÍÓ‚˚È ÌÓÏÂ ˜ÂÍ‡ π%d', [Command.Data.DocumentNumber])));
  //Document.AddLine(WideFormat('◊ÂÍ π%s', [Command.Data.CheckNumber]));
  //Document.AddLine(WideFormat(' ‡ÒÒË %s', [Command.Data.EmployeeName]));
  ...
  Document.AddLine('‘œ: ' + Receipt.FiscalSign);
  Document.AddLine('¬ÂÏˇ: ' + Data.DateTime);
  Document.AddLine('Œ‘ƒ: ' + Data.Cashbox.Ofd.Name);
  Document.AddLine('ƒÎˇ ÔÓ‚ÂÍË ˜ÂÍ‡:');
  ...
  Document.AddLine('»Õ  Œ‘ƒ: ' + Data.Cashbox.IdentityNumber);
  Document.AddLine(' Ó‰   Ã  √ƒ (–ÕÃ): ' + Data.Cashbox.RegistrationNumber);
  Document.AddLine('«ÕÃ: ' + Data.Cashbox.UniqueNumber);
  Document.AddSeparator;
  Document.AddText(Receipt.Trailer.Text);
end;
...
begin
  ...
  try
    ...
    Document.AddSeparator;
    Document.AddLine('‘œ: ' + CheckNumber);
    Document.AddLine('¬ÂÏˇ: ' + Command.Data.RegistratedOn);
    Document.AddLine('Œ‘ƒ: ' + Command.Data.Ofd.Name);
    Document.AddLine('ƒÎˇ ÔÓ‚ÂÍË ˜ÂÍ‡:');
