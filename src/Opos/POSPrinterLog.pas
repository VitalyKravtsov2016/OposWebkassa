...
procedure TPosPrinterLog.MethodEnd(const AMethodName: string; Params: array of const);
var
  P: string;
begin
  P := TLogFile.ParamsToStr2(Params);
  if P <> '' then
    P := '=' + P;
...
procedure TPosPrinterLog.SODataDummy(Status: Integer); safecall;
begin
  MethodStart('SODataDummy', [Status]);
  Driver.SODataDummy(Status);
  MethodEnd('SODataDummy', []);
end;

procedure TPosPrinterLog.SODirectIO(EventNumber: Integer; var pData: Integer; var pString: WideString); safecall;
begin
  MethodStart('SODirectIO', [EventNumber, pData, pString]);
  Driver.SODirectIO(EventNumber,pData,pString);
  MethodEnd('SODirectIO', []);
end;

procedure TPosPrinterLog.SOError(ResultCode: Integer;
  ResultCodeExtended: Integer; ErrorLocus: Integer; var pErrorResponse: Integer); safecall;
begin
  MethodStart('SOError', [ResultCode, ResultCodeExtended, ErrorLocus, pErrorResponse]);
  Driver.SOError(ResultCode, ResultCodeExtended, ErrorLocus, pErrorResponse);
  MethodEnd('SOError', []);
end;

procedure TPosPrinterLog.SOOutputComplete(OutputID: Integer); safecall;
begin
  MethodStart('SOOutputComplete', [OutputID]);
  Driver.SOOutputComplete(OutputID);
  MethodEnd('SOOutputComplete', []);
end;

procedure TPosPrinterLog.SOStatusUpdate(Data: Integer); safecall;
begin
  MethodStart('SOStatusUpdate', [Data]);
  Driver.SOStatusUpdate(Data);
  MethodEnd('SOStatusUpdate', []);
end;

function TPosPrinterLog.SOProcessID: Integer; safecall;
begin
...
function TPosPrinterLog.CheckHealth(Level: Integer): Integer; safecall;
begin
  MethodStart('CheckHealth', [Level]);
  Result := Driver.CheckHealth(Level);
  MethodEnd('CheckHealth', [Result]);
end;

function TPosPrinterLog.ClaimDevice(Timeout: Integer): Integer; safecall;
begin
  MethodStart('ClaimDevice', [Timeout]);
  Result := Driver.ClaimDevice(Timeout);
  MethodEnd('ClaimDevice', [Result]);
end;

function TPosPrinterLog.ClearOutput: Integer; safecall;
begin
...
function TPosPrinterLog.Close: Integer; safecall;
begin
  MethodStart('Close', []);
  Result := Driver.Close;
...
function TPosPrinterLog.DirectIO(Command: Integer; var pData: Integer;
  var pString: WideString): Integer; safecall;
begin
  MethodStart('DirectIO', [Command, pData, pString]);
  Result := Driver.DirectIO(Command, pData, pString);
  MethodEnd('DirectIO', [Result]);
end;

function TPosPrinterLog.Open(const DeviceName: WideString): Integer; safecall;
begin
  MethodStart('Open', [DeviceName]);
  Result := Driver.Open(DeviceName);
  MethodEnd('Open', [Result]);
end;

function TPosPrinterLog.ReleaseDevice: Integer; safecall;
begin
...
function TPosPrinterLog.BeginInsertion(Timeout: Integer): Integer; safecall;
begin
  MethodStart('BeginInsertion', [Timeout]);
  Result := Driver.BeginInsertion(Timeout);
  MethodEnd('BeginInsertion', [Result]);
end;

function TPosPrinterLog.BeginRemoval(Timeout: Integer): Integer; safecall;
begin
  MethodStart('BeginRemoval', [Timeout]);
  Result := Driver.BeginRemoval(Timeout);
  MethodEnd('BeginRemoval', [Result]);
end;

function TPosPrinterLog.CutPaper(Percentage: Integer): Integer; safecall;
begin
  MethodStart('CutPaper', [Percentage]);
  Result := Driver.CutPaper(Percentage);
  MethodEnd('CutPaper', [Result]);
end;

function TPosPrinterLog.EndInsertion: Integer; safecall;
begin
...
function TPosPrinterLog.EndRemoval: Integer; safecall;
begin
...
function TPosPrinterLog.PrintBarCode(Station: Integer; const Data: WideString;
  Symbology: Integer; Height: Integer; Width: Integer; Alignment: Integer; TextPosition: Integer): Integer; safecall;
begin
...
function TPosPrinterLog.PrintBitmap(Station: Integer; const FileName: WideString;
  Width: Integer; Alignment: Integer): Integer; safecall;
begin
  MethodStart('PrintBitmap', [Station, FileName, Width, Alignment]);
  Result := Driver.PrintBitmap(Station, FileName, Width, Alignment);
  MethodEnd('PrintBitmap', [Result]);
end;

function TPosPrinterLog.PrintImmediate(Station: Integer;
  const Data: WideString): Integer; safecall;
begin
  MethodStart('PrintImmediate', [Station, Data]);
  Result := Driver.PrintImmediate(Station, Data);
  MethodEnd('PrintImmediate', [Result]);
end;

function TPosPrinterLog.PrintNormal(Station: Integer;
  const Data: WideString): Integer; safecall;
begin
  MethodStart('PrintNormal', [Station, Data]);
  Result := Driver.PrintNormal(Station, Data);
  MethodEnd('PrintNormal', [Result]);
end;

function TPosPrinterLog.PrintTwoNormal(Stations: Integer;
  const Data1: WideString; const Data2: WideString): Integer; safecall;
begin
  MethodStart('PrintTwoNormal', [Stations, Data1, Data2]);
  Result := Driver.PrintTwoNormal(Stations, Data1, Data2);
  MethodEnd('PrintTwoNormal', [Result]);
end;

function TPosPrinterLog.RotatePrint(Station: Integer; Rotation: Integer): Integer; safecall;
begin
  MethodStart('RotatePrint', [Station, Rotation]);
  Result := Driver.RotatePrint(Station, Rotation);
  MethodEnd('RotatePrint', [Result]);
end;

function TPosPrinterLog.SetBitmap(BitmapNumber: Integer; Station: Integer;
  const FileName: WideString; Width: Integer; Alignment: Integer): Integer; safecall;
begin
  MethodStart('SetBitmap', [BitmapNumber, Station, FileName, Width, Alignment]);
  Result := Driver.SetBitmap(BitmapNumber, Station, FileName, Width, Alignment);
  MethodEnd('SetBitmap', [Result]);
end;

function TPosPrinterLog.SetLogo(Location: Integer; const Data: WideString): Integer; safecall;
begin
  MethodStart('SetLogo', [Location, Data]);
  Result := Driver.SetLogo(Location, Data);
  MethodEnd('SetLogo', [Result]);
end;

function TPosPrinterLog.TransactionPrint(Station: Integer; Control: Integer): Integer; safecall;
begin
  MethodStart('TransactionPrint', [Station, Control]);
  Result := Driver.TransactionPrint(Station, Control);
  MethodEnd('TransactionPrint', [Result]);
end;

function TPosPrinterLog.ValidateData(Station: Integer; const Data: WideString): Integer; safecall;
begin
  MethodStart('ValidateData', [Station, Data]);
  Result := Driver.ValidateData(Station, Data);
  MethodEnd('ValidateData', [Result]);
end;

function TPosPrinterLog.ChangePrintSide(Side: Integer): Integer; safecall;
begin
  MethodStart('ChangePrintSide', [Side]);
  Result := Driver.ChangePrintSide(Side);
  MethodEnd('ChangePrintSide', [Result]);
end;

function TPosPrinterLog.MarkFeed(Type_: Integer): Integer; safecall;
begin
  MethodStart('MarkFeed', [Type_]);
  Result := Driver.MarkFeed(Type_);
  MethodEnd('MarkFeed', [Result]);
end;

function TPosPrinterLog.ResetStatistics(const StatisticsBuffer: WideString): Integer; safecall;
begin
  MethodStart('ResetStatistics', [StatisticsBuffer]);
  Result := Driver.ResetStatistics(StatisticsBuffer);
  MethodEnd('ResetStatistics', [Result]);
end;

function TPosPrinterLog.RetrieveStatistics(var pStatisticsBuffer: WideString): Integer; safecall;
begin
  MethodStart('RetrieveStatistics', [pStatisticsBuffer]);
  Result := Driver.RetrieveStatistics(pStatisticsBuffer);
  MethodEnd('RetrieveStatistics', [Result]);
end;

function TPosPrinterLog.UpdateStatistics(const StatisticsBuffer: WideString): Integer; safecall;
begin
  MethodStart('UpdateStatistics', [StatisticsBuffer]);
  Result := Driver.UpdateStatistics(StatisticsBuffer);
  MethodEnd('UpdateStatistics', [Result]);
end;

function TPosPrinterLog.CompareFirmwareVersion(
  const FirmwareFileName: WideString; out pResult: Integer): Integer; safecall;
begin
  MethodStart('CompareFirmwareVersion', [FirmwareFileName, pResult]);
  Result := Driver.CompareFirmwareVersion(FirmwareFileName, pResult);
  MethodEnd('CompareFirmwareVersion', [Result]);
end;

function TPosPrinterLog.UpdateFirmware(const FirmwareFileName: WideString): Integer; safecall;
begin
  MethodStart('UpdateFirmware', [FirmwareFileName]);
  Result := Driver.UpdateFirmware(FirmwareFileName);
  MethodEnd('UpdateFirmware', [Result]);
end;

function TPosPrinterLog.ClearPrintArea: Integer; safecall;
begin
...
function TPosPrinterLog.PageModePrint(Control: Integer): Integer; safecall;
begin
  MethodStart('PageModePrint', [Control]);
  Result := Driver.PageModePrint(Control);
  MethodEnd('PageModePrint', [Result]);
end;

function TPosPrinterLog.PrintMemoryBitmap(Station: Integer;
  const Data: WideString; Type_: Integer; Width: Integer; Alignment: Integer): Integer; safecall;
begin
  MethodStart('PrintMemoryBitmap', [Station, Data, Type_, Width, Alignment]);
  Result := Driver.PrintMemoryBitmap(Station, Data, Type_, Width, Alignment);
  MethodEnd('PrintMemoryBitmap', [Result]);
end;

function TPosPrinterLog.DrawRuledLine(Station: Integer;
  const PositionList: WideString; LineDirection: Integer; LineWidth: Integer;
  LineStyle: Integer; LineColor: Integer): Integer; safecall;
begin
  MethodStart('DrawRuledLine', [
    Station, PositionList, LineDirection, LineWidth, LineStyle, LineColor]);
  Result := Driver.DrawRuledLine(
    Station, PositionList, LineDirection, LineWidth, LineStyle, LineColor);
  MethodEnd('DrawRuledLine', [Result]);
end;

function TPosPrinterLog.Get_OpenResult: Integer;
begin
...
function TPosPrinterLog.Get_CheckHealthText: WideString;
begin
...
function TPosPrinterLog.Get_Claimed: WordBool;
begin
...
function TPosPrinterLog.Get_OutputID: Integer;
begin
...
function TPosPrinterLog.Get_ResultCode: Integer;
begin
...
function TPosPrinterLog.Get_ResultCodeExtended: Integer;
begin
...
function TPosPrinterLog.Get_State: Integer;
begin
...
function TPosPrinterLog.Get_ControlObjectDescription: WideString;
begin
...
function TPosPrinterLog.Get_ControlObjectVersion: Integer;
begin
...
function TPosPrinterLog.Get_ServiceObjectDescription: WideString;
begin
...
function TPosPrinterLog.Get_ServiceObjectVersion: Integer;
begin
...
function TPosPrinterLog.Get_DeviceDescription: WideString;
begin
...
function TPosPrinterLog.Get_DeviceName: WideString;
begin
...
function TPosPrinterLog.Get_CapConcurrentJrnRec: WordBool;
begin
...
function TPosPrinterLog.Get_CapConcurrentJrnSlp: WordBool;
begin
...
function TPosPrinterLog.Get_CapConcurrentRecSlp: WordBool;
begin
...
function TPosPrinterLog.Get_CapCoverSensor: WordBool;
begin
...
function TPosPrinterLog.Get_CapJrn2Color: WordBool;
begin
...
function TPosPrinterLog.Get_CapJrnBold: WordBool;
begin
...
function TPosPrinterLog.Get_CapJrnDhigh: WordBool;
begin
...
function TPosPrinterLog.Get_CapJrnDwide: WordBool;
begin
...
function TPosPrinterLog.Get_CapJrnDwideDhigh: WordBool;
begin
...
function TPosPrinterLog.Get_CapJrnEmptySensor: WordBool;
begin
...
function TPosPrinterLog.Get_CapJrnItalic: WordBool;
begin
...
function TPosPrinterLog.Get_CapJrnNearEndSensor: WordBool;
begin
...
function TPosPrinterLog.Get_CapJrnPresent: WordBool;
begin
...
function TPosPrinterLog.Get_CapJrnUnderline: WordBool;
begin
...
function TPosPrinterLog.Get_CapRec2Color: WordBool;
begin
...
function TPosPrinterLog.Get_CapRecBarCode: WordBool;
begin
...
function TPosPrinterLog.Get_CapRecBitmap: WordBool;
begin
...
function TPosPrinterLog.Get_CapRecBold: WordBool;
begin
...
function TPosPrinterLog.Get_CapRecDhigh: WordBool;
begin
...
function TPosPrinterLog.Get_CapRecDwide: WordBool;
begin
...
function TPosPrinterLog.Get_CapRecDwideDhigh: WordBool;
begin
...
function TPosPrinterLog.Get_CapRecEmptySensor: WordBool;
begin
...
function TPosPrinterLog.Get_CapRecItalic: WordBool;
begin
...
function TPosPrinterLog.Get_CapRecLeft90: WordBool;
begin
...
function TPosPrinterLog.Get_CapRecNearEndSensor: WordBool;
begin
...
function TPosPrinterLog.Get_CapRecPapercut: WordBool;
begin
...
function TPosPrinterLog.Get_CapRecPresent: WordBool;
begin
...
function TPosPrinterLog.Get_CapRecRight90: WordBool;
begin
...
function TPosPrinterLog.Get_CapRecRotate180: WordBool;
begin
...
function TPosPrinterLog.Get_CapRecStamp: WordBool;
begin
...
function TPosPrinterLog.Get_CapRecUnderline: WordBool;
begin
...
function TPosPrinterLog.Get_CapSlp2Color: WordBool;
begin
...
function TPosPrinterLog.Get_CapSlpBarCode: WordBool;
begin
...
function TPosPrinterLog.Get_CapSlpBitmap: WordBool;
begin
...
function TPosPrinterLog.Get_CapSlpBold: WordBool;
begin
...
function TPosPrinterLog.Get_CapSlpDhigh: WordBool;
begin
...
function TPosPrinterLog.Get_CapSlpDwide: WordBool;
begin
...
function TPosPrinterLog.Get_CapSlpDwideDhigh: WordBool;
begin
...
function TPosPrinterLog.Get_CapSlpEmptySensor: WordBool;
begin
...
function TPosPrinterLog.Get_CapSlpFullslip: WordBool;
begin
...
function TPosPrinterLog.Get_CapSlpItalic: WordBool;
begin
...
function TPosPrinterLog.Get_CapSlpLeft90: WordBool;
begin
...
function TPosPrinterLog.Get_CapSlpNearEndSensor: WordBool;
begin
...
function TPosPrinterLog.Get_CapSlpPresent: WordBool;
begin
...
function TPosPrinterLog.Get_CapSlpRight90: WordBool;
begin
...
function TPosPrinterLog.Get_CapSlpRotate180: WordBool;
begin
...
function TPosPrinterLog.Get_CapSlpUnderline: WordBool;
begin
...
function TPosPrinterLog.Get_CharacterSetList: WideString;
begin
...
function TPosPrinterLog.Get_CoverOpen: WordBool;
begin
...
function TPosPrinterLog.Get_ErrorStation: Integer;
begin
...
function TPosPrinterLog.Get_JrnEmpty: WordBool;
begin
...
function TPosPrinterLog.Get_JrnLineCharsList: WideString;
begin
...
function TPosPrinterLog.Get_JrnLineWidth: Integer;
begin
...
function TPosPrinterLog.Get_JrnNearEnd: WordBool;
begin
...
function TPosPrinterLog.Get_RecEmpty: WordBool;
begin
...
function TPosPrinterLog.Get_RecLineCharsList: WideString;
begin
...
function TPosPrinterLog.Get_RecLinesToPaperCut: Integer;
begin
...
function TPosPrinterLog.Get_RecLineWidth: Integer;
begin
...
function TPosPrinterLog.Get_RecNearEnd: WordBool;
begin
...
function TPosPrinterLog.Get_RecSidewaysMaxChars: Integer;
begin
...
function TPosPrinterLog.Get_RecSidewaysMaxLines: Integer;
begin
...
function TPosPrinterLog.Get_SlpEmpty: WordBool;
begin
...
function TPosPrinterLog.Get_SlpLineCharsList: WideString;
begin
...
function TPosPrinterLog.Get_SlpLinesNearEndToEnd: Integer;
begin
...
function TPosPrinterLog.Get_SlpLineWidth: Integer;
begin
...
function TPosPrinterLog.Get_SlpMaxLines: Integer;
begin
...
function TPosPrinterLog.Get_SlpNearEnd: WordBool;
begin
...
function TPosPrinterLog.Get_SlpSidewaysMaxChars: Integer;
begin
...
function TPosPrinterLog.Get_SlpSidewaysMaxLines: Integer;
begin
...
function TPosPrinterLog.Get_CapCharacterSet: Integer;
begin
...
function TPosPrinterLog.Get_CapTransaction: WordBool;
begin
...
function TPosPrinterLog.Get_ErrorLevel: Integer;
begin
...
function TPosPrinterLog.Get_ErrorString: WideString;
begin
...
function TPosPrinterLog.Get_FontTypefaceList: WideString;
begin
...
function TPosPrinterLog.Get_RecBarCodeRotationList: WideString;
begin
...
function TPosPrinterLog.Get_SlpBarCodeRotationList: WideString;
begin
...
function TPosPrinterLog.Get_CapPowerReporting: Integer;
begin
...
function TPosPrinterLog.Get_PowerState: Integer;
begin
...
function TPosPrinterLog.Get_CapJrnCartridgeSensor: Integer;
begin
...
function TPosPrinterLog.Get_CapJrnColor: Integer;
begin
...
function TPosPrinterLog.Get_CapRecCartridgeSensor: Integer;
begin
...
function TPosPrinterLog.Get_CapRecColor: Integer;
begin
...
function TPosPrinterLog.Get_CapRecMarkFeed: Integer;
begin
...
function TPosPrinterLog.Get_CapSlpBothSidesPrint: WordBool;
begin
...
function TPosPrinterLog.Get_CapSlpCartridgeSensor: Integer;
begin
...
function TPosPrinterLog.Get_CapSlpColor: Integer;
begin
...
function TPosPrinterLog.Get_JrnCartridgeState: Integer;
begin
...
function TPosPrinterLog.Get_RecCartridgeState: Integer;
begin
...
function TPosPrinterLog.Get_SlpCartridgeState: Integer;
begin
...
function TPosPrinterLog.Get_SlpPrintSide: Integer;
begin
...
function TPosPrinterLog.Get_CapMapCharacterSet: WordBool;
begin
...
function TPosPrinterLog.Get_RecBitmapRotationList: WideString;
begin
...
function TPosPrinterLog.Get_SlpBitmapRotationList: WideString;
begin
...
function TPosPrinterLog.Get_CapStatisticsReporting: WordBool;
begin
...
function TPosPrinterLog.Get_CapUpdateStatistics: WordBool;
begin
...
function TPosPrinterLog.Get_CapCompareFirmwareVersion: WordBool;
begin
...
function TPosPrinterLog.Get_CapUpdateFirmware: WordBool;
begin
...
function TPosPrinterLog.Get_CapConcurrentPageMode: WordBool;
begin
...
function TPosPrinterLog.Get_CapRecPageMode: WordBool;
begin
...
function TPosPrinterLog.Get_CapSlpPageMode: WordBool;
begin
...
function TPosPrinterLog.Get_PageModeArea: WideString;
begin
...
function TPosPrinterLog.Get_PageModeDescriptor: Integer;
begin
...
function TPosPrinterLog.Get_CapRecRuledLine: Integer;
begin
...
function TPosPrinterLog.Get_CapSlpRuledLine: Integer;
begin
...
function TPosPrinterLog.Get_DeviceEnabled: WordBool;
begin
...
procedure TPosPrinterLog.Set_DeviceEnabled(pDeviceEnabled: WordBool);
begin
...
function TPosPrinterLog.Get_FreezeEvents: WordBool;
begin
...
procedure TPosPrinterLog.Set_FreezeEvents(pFreezeEvents: WordBool);
begin
...
function TPosPrinterLog.Get_AsyncMode: WordBool;
begin
...
procedure TPosPrinterLog.Set_AsyncMode(pAsyncMode: WordBool);
begin
...
function TPosPrinterLog.Get_CharacterSet: Integer;
begin
...
procedure TPosPrinterLog.Set_CharacterSet(pCharacterSet: Integer);
begin
...
function TPosPrinterLog.Get_FlagWhenIdle: WordBool;
begin
...
procedure TPosPrinterLog.Set_FlagWhenIdle(pFlagWhenIdle: WordBool);
begin
...
function TPosPrinterLog.Get_JrnLetterQuality: WordBool;
begin
...
procedure TPosPrinterLog.Set_JrnLetterQuality(pJrnLetterQuality: WordBool);
begin
...
function TPosPrinterLog.Get_JrnLineChars: Integer;
begin
...
procedure TPosPrinterLog.Set_JrnLineChars(pJrnLineChars: Integer);
begin
...
function TPosPrinterLog.Get_JrnLineHeight: Integer;
begin
...
procedure TPosPrinterLog.Set_JrnLineHeight(pJrnLineHeight: Integer);
begin
...
function TPosPrinterLog.Get_JrnLineSpacing: Integer;
begin
...
procedure TPosPrinterLog.Set_JrnLineSpacing(pJrnLineSpacing: Integer);
begin
...
function TPosPrinterLog.Get_MapMode: Integer;
begin
...
procedure TPosPrinterLog.Set_MapMode(pMapMode: Integer);
begin
...
function TPosPrinterLog.Get_RecLetterQuality: WordBool;
begin
...
procedure TPosPrinterLog.Set_RecLetterQuality(pRecLetterQuality: WordBool);
begin
...
function TPosPrinterLog.Get_RecLineChars: Integer;
begin
...
procedure TPosPrinterLog.Set_RecLineChars(pRecLineChars: Integer);
begin
...
function TPosPrinterLog.Get_RecLineHeight: Integer;
begin
...
procedure TPosPrinterLog.Set_RecLineHeight(pRecLineHeight: Integer);
begin
...
function TPosPrinterLog.Get_RecLineSpacing: Integer;
begin
...
procedure TPosPrinterLog.Set_RecLineSpacing(pRecLineSpacing: Integer);
begin
...
function TPosPrinterLog.Get_SlpLetterQuality: WordBool;
begin
...
procedure TPosPrinterLog.Set_SlpLetterQuality(pSlpLetterQuality: WordBool);
begin
...
function TPosPrinterLog.Get_SlpLineChars: Integer;
begin
...
procedure TPosPrinterLog.Set_SlpLineChars(pSlpLineChars: Integer);
begin
...
function TPosPrinterLog.Get_SlpLineHeight: Integer;
begin
...
procedure TPosPrinterLog.Set_SlpLineHeight(pSlpLineHeight: Integer);
begin
...
function TPosPrinterLog.Get_SlpLineSpacing: Integer;
begin
...
procedure TPosPrinterLog.Set_SlpLineSpacing(pSlpLineSpacing: Integer);
begin
...
function TPosPrinterLog.Get_RotateSpecial: Integer;
begin
...
procedure TPosPrinterLog.Set_RotateSpecial(pRotateSpecial: Integer);
begin
...
function TPosPrinterLog.Get_BinaryConversion: Integer;
begin
...
procedure TPosPrinterLog.Set_BinaryConversion(pBinaryConversion: Integer);
begin
...
function TPosPrinterLog.Get_PowerNotify: Integer;
begin
...
procedure TPosPrinterLog.Set_PowerNotify(pPowerNotify: Integer);
begin
...
function TPosPrinterLog.Get_CartridgeNotify: Integer;
begin
...
procedure TPosPrinterLog.Set_CartridgeNotify(pCartridgeNotify: Integer);
begin
...
function TPosPrinterLog.Get_JrnCurrentCartridge: Integer;
begin
...
procedure TPosPrinterLog.Set_JrnCurrentCartridge(pJrnCurrentCartridge: Integer);
begin
...
function TPosPrinterLog.Get_RecCurrentCartridge: Integer;
begin
...
procedure TPosPrinterLog.Set_RecCurrentCartridge(pRecCurrentCartridge: Integer);
begin
...
function TPosPrinterLog.Get_SlpCurrentCartridge: Integer;
begin
...
procedure TPosPrinterLog.Set_SlpCurrentCartridge(pSlpCurrentCartridge: Integer);
begin
...
function TPosPrinterLog.Get_MapCharacterSet: WordBool;
begin
...
procedure TPosPrinterLog.Set_MapCharacterSet(pMapCharacterSet: WordBool);
begin
...
function TPosPrinterLog.Get_PageModeHorizontalPosition: Integer;
begin
...
procedure TPosPrinterLog.Set_PageModeHorizontalPosition(pPageModeHorizontalPosition: Integer);
begin
...
function TPosPrinterLog.Get_PageModePrintArea: WideString;
begin
...
procedure TPosPrinterLog.Set_PageModePrintArea(const pPageModePrintArea: WideString);
begin
...
function TPosPrinterLog.Get_PageModePrintDirection: Integer;
begin
...
procedure TPosPrinterLog.Set_PageModePrintDirection(pPageModePrintDirection: Integer);
begin
...
function TPosPrinterLog.Get_PageModeStation: Integer;
begin
...
procedure TPosPrinterLog.Set_PageModeStation(pPageModeStation: Integer);
begin
...
function TPosPrinterLog.Get_PageModeVerticalPosition: Integer;
begin
...
procedure TPosPrinterLog.Set_PageModeVerticalPosition(pPageModeVerticalPosition: Integer);
begin
