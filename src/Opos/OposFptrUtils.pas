...
function IsValidFptrStatusUpdateEvent(Code: Integer): Boolean;
...
begin
  case Code of
   FPTR_SUE_COVER_OPEN,
   FPTR_SUE_COVER_OK,
   FPTR_SUE_JRN_COVER_OPEN,
   FPTR_SUE_JRN_COVER_OK,
   FPTR_SUE_REC_COVER_OPEN,
   FPTR_SUE_REC_COVER_OK,
   FPTR_SUE_SLP_COVER_OPEN,
   FPTR_SUE_SLP_COVER_OK,
   FPTR_SUE_JRN_EMPTY,
