...
type
  { TEscPrinterSewooTest }

  TEscPrinterSewooTest = class(TTestCase)
  private
    FLogger: ILogFile;
...
procedure TEscPrinterSewooTest.SetUp;
begin
  inherited SetUp;
...
procedure TEscPrinterSewooTest.TearDown;
begin
  FPrinter.Free;
  FPrinterPort := nil;
  inherited TearDown;
...
function TEscPrinterSewooTest.CreateUSBPort: TUSBPrinterPort;
begin
  Result := TUSBPrinterPort.Create(FLogger, ReadSewooPortName);
end;

function TEscPrinterSewooTest.CreateRawPort: TRawPrinterPort;
begin
  Result := TRawPrinterPort.Create(FLogger, 'RONGTA 80mm Series Printer');
end;

function TEscPrinterSewooTest.CreateSerialPort: TSerialPort;
var
...
function TEscPrinterSewooTest.CreateSocketPort: TSocketPort;
var
...
procedure TEscPrinterSewooTest.TestPrintText;
begin
...
procedure TEscPrinterSewooTest.TestInitialize;
begin
  FPrinter.Initialize;
  FPrinter.SetCodePage(CODEPAGE_WCP1251);
end;

procedure TEscPrinterSewooTest.TestReadStatus;
var
...
procedure TEscPrinterSewooTest.TestPrintMode;
var
...
procedure TEscPrinterSewooTest.TestPrintModeInLine;
var
  PrintMode: TPrintMode;
begin
  // Normal mode, font A
...
procedure TEscPrinterSewooTest.TestBarcode;
begin
...
procedure TEscPrinterSewooTest.TestBarcode2;
begin
  FPrinter.SetNormalPrintMode;
  FPrinter.SetBarcodeLeft(50);
  FPrinter.SetBarcodeHeight(50);
...
procedure TEscPrinterSewooTest.TestPDF417;
var
  Barcode: TPDF417;
const
...
procedure TEscPrinterSewooTest.TestQRCode;
var
  QRCode: TQRCode;
begin
  QRCode.Model := 2;
...
procedure TEscPrinterSewooTest.TestQRCodeECL;
var
  QRCode: TQRCode;
begin
  QRCode.Model := 2;
...
procedure TEscPrinterSewooTest.TestQRCodeModuleSize;
var
  QRCode: TQRCode;
begin
  FPrinter.Initialize;
...
procedure TEscPrinterSewooTest.TestQRCodeJustification;
var
  QRCode: TQRCode;
begin
  FPrinter.Initialize;
...
procedure TEscPrinterSewooTest.TestBitmap;
var
  Bitmap: TBitmap;
  FileName: string;
begin
...
procedure TEscPrinterSewooTest.TestPrintRasterBMP;
var
  Bitmap: TBitmap;
begin
  Bitmap := TBitmap.Create;
...
procedure TEscPrinterSewooTest.TestReadPrinterID;
begin
  CheckEquals('EPSON', FPrinter.ReadManufacturer, 'ReadManufacturer');
  CheckEquals('SLK SERIES', FPrinter.ReadPrinterName, 'ReadPrinterName');
  CheckEquals('TS400EBENGV104', FPrinter.ReadSerialNumber, 'ReadSerialNumber');
  CheckEquals('7.00 ESC/POS', FPrinter.ReadFirmwareVersion, 'ReadFirmwareVersion');
end;

procedure TEscPrinterSewooTest.PrintTestPage;
begin
  FPrinter.Initialize;
  FPrinter.PrintTestPage;
end;

procedure TEscPrinterSewooTest.TestJustification;
var
  QRCode: TQRCode;
begin
  FPrinter.Initialize;
...
procedure TEscPrinterSewooTest.TestJustification2;
begin
  FPrinter.Initialize;
...
procedure TEscPrinterSewooTest.TestUnderlined;
var
  PrintMode: TPrintMode;
begin
  FPrinter.Initialize;
...
procedure TEscPrinterSewooTest.TestBeepParams;
begin
  FPrinter.Initialize;
  FPrinter.SetBeepParams(3, 1);
end;

procedure TEscPrinterSewooTest.TestEmphasized;
begin
  FPrinter.Initialize;
...
procedure TEscPrinterSewooTest.TestDoubleStrikeMode;
begin
  FPrinter.Initialize;
...
procedure TEscPrinterSewooTest.TestCharacterFont;
begin
  FPrinter.Initialize;
...
procedure TEscPrinterSewooTest.TestCodePage;
const
...
procedure TEscPrinterSewooTest.TestCodePage2;
const
  TextCodePage1251: WideString = 'Кодовая страница 1251';
  TextCodePage866: WideString = 'Кодовая страница 866';
var
...
procedure TEscPrinterSewooTest.TestCodePages;
var
  i: Integer;
  Text: AnsiString;
begin
...
procedure TEscPrinterSewooTest.TestNVBitImage;
var
  Bitmap: TBitmap;
  FileName: string;
begin
...
procedure TEscPrinterSewooTest.TestCoverOpen;
var
  i: Integer;
begin
  FPrinter.Initialize;
...
procedure TEscPrinterSewooTest.TestRecoverError;
var
  ErrorStatus: TErrorStatus;
begin
  ErrorStatus := FPrinter.ReadErrorStatus;
...
procedure TEscPrinterSewooTest.TestLineSpacing;
var
  i: Integer;
begin
  FPrinter.Initialize;
...
procedure TEscPrinterSewooTest.TestCutDistanceFontA;
begin
  FPrinter.Initialize;
  FPrinter.SetLineSpacing(0);
  FPrinter.SetCharacterFont(0);
...
procedure TEscPrinterSewooTest.TestCutDistanceFontB;
begin
  FPrinter.Initialize;
  FPrinter.SetLineSpacing(0);
  FPrinter.SetCharacterFont(1);
...
procedure TEscPrinterSewooTest.TestUserCharacter;
begin
  FPrinter.Initialize;
  // FONT A
  FPrinter.SetCharacterFont(FONT_TYPE_A);
...
procedure TEscPrinterSewooTest.TestBitmap2;
const
  DownloadBMPCommand =
...
procedure TEscPrinterSewooTest.TestPageMode;
const
  Separator = '------------------------------------------------';
...
procedure TEscPrinterSewooTest.TestPageModeA;
const
  Separator = '------------------------------------------------';
...
procedure TEscPrinterSewooTest.TestPageModeA2;
const
  Separator = '------------------------------------------------';
  Barcode = 'http://dev.kofd.kz/consumer?i=1556041617048&f=768814097419&s=3098.00&t=20241211T151839';
var
...
procedure TEscPrinterSewooTest.TestPageModeB;
const
  Separator = '----------------------------------------------------------------';
  Barcode = 't=20240719T1314&s=460.00&fn=7380440700076549&i=41110&fp=2026476352&n=1';
var
...
procedure TEscPrinterSewooTest.PrintCodePage;
var
  i: Integer;
  S: AnsiString;
begin
...
procedure TEscPrinterSewooTest.PrintCodePageUTF8;
var
  i: Integer;
  S: AnsiString;
begin
...
procedure TEscPrinterSewooTest.PrintCodePage2;
var
  i: Integer;
  S: AnsiString;
begin
...
procedure TEscPrinterSewooTest.PrintCodePages(const CodePageName: string);
begin
  FPrinter.PrintText('-----------------------------------------' + CRLF);
...
procedure TEscPrinterSewooTest.TestPrintRussianFontB;
var
  CodePage: Integer;
begin
  FPrinter.Initialize;
...
procedure TEscPrinterSewooTest.TestCutterError;
var
  i: Integer;
  P: Integer;
  Line: string;
...
initialization
  RegisterTest('', TEscPrinterSewooTest.Suite);
