...
begin
  ...
  FParams.AddUnitName('ë.', 'ëèòð', 1);
  FParams.AddUnitName('Ë', 'ëèòð', 2);
end;
...
begin
  ...
  CheckEquals('ë.', FParams.UnitNames[0].AppName, 'UnitNames[0].AppName');
  CheckEquals('ëèòð', FParams.UnitNames[0].SrvName, 'UnitNames[0].SrvName');
  CheckEquals(1, FParams.UnitNames[0].SrvCode, 'UnitNames[0].SrvCode');
  CheckEquals('Ë', FParams.UnitNames[1].AppName, 'UnitNames[1].AppName');
  CheckEquals('ëèòð', FParams.UnitNames[1].SrvName, 'UnitNames[1].SrvName');
