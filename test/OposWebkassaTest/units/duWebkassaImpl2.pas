...
PrintNormal(2,    Восточно-Казастанская область, город   
): 0
PrintNormal(2,   Усть-Каменогорск, ул. Грейдерная, 1/10  
): 0
PrintNormal(2,             ТОО PetroRetail               
): 0
PrintNormal(2, НДС Серия 00000                    № 00000
): 0
PrintNormal(2, ------------------------------------------
): 0
PrintNormal(2,                      
): 0
PrintNormal(2,                  СМЕНА №0
): 0
PrintNormal(2, ПРОДАЖА
): 0
PrintNormal(2, ------------------------------------------
): 0
...
PrintNormal(2,    1.000 кг x 123.45 тг
): 0
PrintNormal(2,    Стоимость                        123.45
): 0
Get_CapRecBarCode(): True
PrintBarCode(2, 3850504580002030, 203, 100, 0, -2, -11): 0
PrintNormal(2, ------------------------------------------
): 0
PrintNormal(2, |4CИТОГ          =123.45
): 0
PrintNormal(2, Банковская карта:                  =123.45
): 0
PrintNormal(2, в т.ч. НДС 12%                      =13.23
): 0
PrintNormal(2, ------------------------------------------
): 0
PrintNormal(2, Фискальный признак: 
): 0
PrintNormal(2, Время: 
): 0
PrintNormal(2, Оператор фискальных данных:
): 0
PrintNormal(2, 
): 0
PrintNormal(2, Для проверки чека зайдите на сайт:
): 0
PrintNormal(2, 
): 0
PrintNormal(2, ------------------------------------------
): 0
PrintNormal(2,               ФИСКАЛЬНЫЙ ЧЕK
): 0
Get_CapRecBarCode(): True
PrintBarCode(2, , 204, 0, 4, -2, -11): 0
PrintNormal(2, 
): 0
PrintNormal(2,                 ИНК ОФД: 
): 0
PrintNormal(2,            Код ККМ КГД (РНМ): 
): 0
PrintNormal(2,                   ЗНМ: 
): 0
PrintNormal(2,            Callцентр 039458039850         
): 0
PrintNormal(2,           Горячая линия 20948802934       
): 0
PrintNormal(2,             СПАСИБО ЗА ПОКУПКУ
): 0
