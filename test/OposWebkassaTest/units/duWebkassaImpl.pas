...
begin
  ...
  CheckEquals(FPTR_PS_FISCAL_RECEIPT, Driver.GetPropertyNumber(PIDXFptr_PrinterState));
  FptrCheck(Driver.PrintRecItem('Item 1', 123.45, 1000, 1, 123.45, 'кг'));
  FptrCheck(Driver.PrintRecItem('Item 2', 123.45, 1000, 2, 123.45, 'кг'));
  FptrCheck(Driver.PrintRecItem('Item 3', 123.45, 1000, 3, 123.45, 'кг'));
  FptrCheck(Driver.PrintRecItem('Item 4', 123.45, 1000, 4, 123.45, 'кг'));
...
begin
  ...
  CheckEquals(FPTR_PS_FISCAL_RECEIPT, Driver.GetPropertyNumber(PIDXFptr_PrinterState));
  FptrCheck(Driver.PrintRecItem('Item 1', 123.45, 1000, 1, 123.45, 'кг'));
  FptrCheck(Driver.PrintRecItem('Item 1', 123.45, 1000, 2, 123.45, 'кг'));
  FptrCheck(Driver.PrintRecItem('Item 1', 123.45, 1000, 3, 123.45, 'кг'));
  FptrCheck(Driver.PrintRecItem('Item 1', 123.45, 1000, 4, 123.45, 'кг'));
